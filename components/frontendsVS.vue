...
section#frontends
	...
	swipe#gallery.my-swipe
		//- create buttons for slider, make first checked by default
		swipeitem.slide1
			.info
			...
			.img
				img(src="/img/melissa.jpg" alt="Melissa De Leon's Website")
		...
		swipeitem.slide2
			...
			.img
				img(src="/img/mteach.jpg" alt="MCCC Teach Page")
		...
		swipeitem.slide3
			...
			.img
				img(src="/img/summerinfo.jpg" alt="MCCC Summer Session 2015 Information Page")
		...
		swipeitem.slide4
			...
			.img
				img(src="/img/abwow.jpg" alt="A Bird Without Wings Information Site/Blog")
		...
		swipeitem.slide5
			...
			.img
				img(src="/img/sjhg.jpg" alt="South Jersey Heart Group Site")
		...
		swipeitem.slide6
			...
			.img
				img(src="/img/daveflyer.jpg" alt="David Silverman Talk Flyer")
</template>
