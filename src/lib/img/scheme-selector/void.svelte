<svg width="32" height="32" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg"
	...
	><g mask="url(#prefix__a)" fill="var(--border)"
		...
		/><path
			d="M60.249 31.977c1.288-3.483 6.214-3.483 7.502 0l6.998 18.91a4 4 0 002.363 2.364l18.911 6.998c3.483 1.288 3.483 6.214 0 7.502l-18.91 6.998a4 4 0 00-2.364 2.363l-6.998 18.911c-1.288 3.483-6.214 3.483-7.502 0l-6.998-18.91a4 4 0 00-2.363-2.364l-18.911-6.998c-3.483-1.288-3.483-6.214 0-7.502l18.91-6.998a4 4 0 002.364-2.363l6.998-18.911z"
		/></g
	></svg
>
